            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  Currently pursuing a Bachelor of Science in Computer Science from National University of Sciences and Technology, NUST (2021-2025).
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-primary/5 to-accent/5 p-8 rounded-lg">
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">BS Computer Science Student (2021-2025)</span>
              </li>
              <li className="flex items-center space-x-3">
                <span className="w-2 h-2 bg-primary rounded-full"></span>
